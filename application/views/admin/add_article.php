        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Add Article <span></span></h3>
                </div>
                <div class="card-body">
                    <form action="<?php echo base_url('admin/add_article');?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control input-style" id="exampleInputEmail1"
                                        aria-describedby="emailHelp"  value="<?php echo set_value('title');?>" placeholder="Enter Title">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputPassword1" class="input__label">Slug</label>
                                    <input type="text" name="slug" class="form-control input-style"  value="<?php echo set_value('slug');?>" id="exampleInputPassword1"
                                        placeholder="Enter Slug">
                                        <small id="emailHelp" class="form-text text-muted">Must be unique and does not contain spaces</small>
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" name="image" for="validatedCustomFile">Choose file...</label>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="for-group">
                                <label for="exampleInputPassword1" class="input__label">Article Summary</label>
                                <textarea name="summary"  id="" class="form-control" cols="30" rows="10"><?php echo set_value('summary');?></textarea>
                                <?php echo form_error('summary') ?>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="for-group">
                                <label for="exampleInputPassword1" class="input__label">Article Body</label>
                                <textarea name="body"  id="" class="form-control" cols="30" rows="10"><?php echo set_value('body');?></textarea>
